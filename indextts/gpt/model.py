...
class GPT2InferenceModel(GPT2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        if isinstance(past_key_values_out, Cache):
            ...
            # Ensure we always return legacy tuples after converting the input cache.
...
class UnifiedVoice(nn.Module):
    ...
    def forward(self, speech_conditioning_latent, text_inputs, text_lengths, mel_codes, wav_lengths,
        ...
        mel_codes_lengths = torch.ceil(
            wav_lengths / self.mel_length_compression).long() + 1
    ...
    def inference_speech(self, speech_conditioning_mel, text_inputs, cond_mel_lengths=None, input_tokens=None, num_return_sequences=1,
        ...
        conds_latent = self.get_conditioning(
            speech_conditioning_mel, cond_mel_lengths)
